package com.olen.mobile.app.widget.pullToRefreshListView.internal;
...
import com.olen.mobile.app.widget.pullToRefreshListView.PullToRefreshBase;
...
public class LoadingLayout extends FrameLayout {
	...
	public LoadingLayout(Context context, final int mode, String releaseLabel, String pullLabel, String refreshingLabel) {
		...
		subHeaderText = (TextView) header.findViewById(R.id.pull_to_refresh_sub_text);
...
//				headerImage.setImageResource(R.drawable.pulltorefresh_down_arrow);
				headerImage.setImageResource(R.drawable.ic_refresh_down);
				break;
		}
	}
