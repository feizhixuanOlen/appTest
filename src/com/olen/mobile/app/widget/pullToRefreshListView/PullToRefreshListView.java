package com.olen.mobile.app.widget.pullToRefreshListView;
...
import com.olen.mobile.app.widget.pullToRefreshListView.internal.EmptyViewMethodAccessor;
import com.olen.mobile.app.widget.pullToRefreshListView.internal.LoadingLayout;
	...
	protected final ListView createRefreshableView(Context context, AttributeSet attrs) {
		...
		if (mode == MODE_PULL_DOWN_TO_REFRESH || mode == MODE_BOTH) {
			...
			headerLoadingView = new LoadingLayout(context, MODE_PULL_DOWN_TO_REFRESH, releaseLabel, pullLabel,
					refreshingLabel);
			frame.addView(headerLoadingView, FrameLayout.LayoutParams.MATCH_PARENT,
		...
		if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
			...
			footerLoadingView = new LoadingLayout(context, MODE_PULL_UP_TO_REFRESH, releaseLabel, pullLabel,
					refreshingLabel);
			frame.addView(footerLoadingView, FrameLayout.LayoutParams.MATCH_PARENT,
					FrameLayout.LayoutParams.WRAP_CONTENT);
